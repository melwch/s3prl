...
from extools.ffmpeg_normalize._cmd_utils import get_ffmpeg_exe, ffmpeg_has_loudnorm
from extools.ffmpeg_normalize.media_file import MediaFile
from extools.ffmpeg_normalize._errors import FFmpegNormalizeError
from extools.ffmpeg_normalize._logger import setup_custom_logger
...
class FFmpegNormalize:
    ...
    def run_normalization(self):
        ...
        for index, media_file in enumerate(
            ...
            try:
                return media_file.run_normalization()
            except Exception as e:
